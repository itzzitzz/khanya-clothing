                  ...
                  <tr>
                    <td style="padding: 40px 30px;">
                      ...
                      <div style="background-color: #dcfce7; border-left: 4px solid #16a34a; padding: 20px; margin: 30px 0; border-radius: 8px;">
                        <h2 style="margin: 0 0 15px 0; color: #166534; font-size: 20px; font-weight: bold;">
                          💰 Payment Details
                        </h2>
                      ...
                      <p style="margin: 20px 0 0 0; color: #374151; font-size: 16px; line-height: 1.6;">
                        Thank you for choosing Khanya! We appreciate your business. 🙏
                      </p>
                  ...
                  <tr>
                    <td style="background-color: #f9fafb; padding: 30px; text-align: center; border-top: 1px solid #e5e7eb;">
                      <p style="margin: 0; color: #6b7280; font-size: 14px;">
                        Questions? Contact us at <a href="mailto:sales@khanya.store" style="color: #16a34a;">sales@khanya.store</a>
                      </p>
                    </td>
                  </tr>
                </table>
              ...
              <td align="center">
                <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                  ...
                  <tr>
                    <td style="padding: 40px 30px;">
                      ...
                      <div style="background-color: #dbeafe; border-left: 4px solid #3b82f6; padding: 20px; margin: 30px 0; border-radius: 8px;">
                        <h2 style="margin: 0 0 15px 0; color: #1e40af; font-size: 20px; font-weight: bold;">
                          💳 Payment Summary
                        </h2>
                        <table width="100%" cellpadding="8" cellspacing="0">
                          <tr>
                  ...
                  <tr>
                    <td style="background-color: #f9fafb; padding: 30px; text-align: center; border-top: 1px solid #e5e7eb;">
                      <p style="margin: 0; color: #6b7280; font-size: 14px;">
                        Questions? Contact us at <a href="mailto:sales@khanya.store" style="color: #3b82f6;">sales@khanya.store</a>
                      </p>
                    </td>
                  </tr>
                </table>
