...
function generateThankYouEmailHTML(customerName: string): string {
  const baseStyles = `
    <style>
      body { font-family: Inter, 'Helvetica', 'Arial', sans-serif; margin: 0; padding: 0; background: #f5f5f5; }
      .container { max-width: 600px; margin: 0 auto; padding: 40px 20px; }
      .header { text-align: center; padding: 30px; background: linear-gradient(135deg, #2E4D38 0%, #3d6a4a 100%); border-radius: 12px 12px 0 0; }
      .header h1 { color: white; margin: 0; font-size: 28px; }
      .content { background: white; padding: 40px; border-radius: 0 0 12px 12px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); }
      .content p { line-height: 1.8; color: #333; margin: 0 0 20px 0; font-size: 16px; }
      .footer { text-align: center; padding: 20px; color: #888; font-size: 12px; }
      .footer a { color: #2E4D38; text-decoration: none; }
    </style>
  `;
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <p>We wanted to take a moment to say <strong>thank you</strong> for choosing Khanya for your clothing bale purchases. Your support means the world to us!</p>
          
          <p>We truly appreciate your business and hope that our products have helped you grow your reselling venture. At Khanya, we're committed to providing quality bales at great prices, and your trust in us makes it all worthwhile.</p>
          
          <p>If you've had a positive experience with us, we'd be incredibly grateful if you could share it with others. Your feedback helps other entrepreneurs find us and helps us improve!</p>
          ...
          <p>Ready to stock up again? Visit our store at <a href="https://khanya.store" style="color: #2E4D38; font-weight: bold;">khanya.store</a> to see our latest bales!</p>
          
          <p>Thank you once again for being part of the Khanya family. We look forward to serving you again soon!</p>
