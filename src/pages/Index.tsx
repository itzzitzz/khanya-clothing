        ...
        <section id="gallery" className="bg-secondary/50 py-16">
          <div className="container mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[{ src: baleImg, alt: "Two Khanya entrepreneurs proudly displaying quality clothing from their business" }, { src: flatlayImg, alt: "Assorted men's, women's and children's clothing laid out neatly" }, { src: "/lovable-uploads/bale-with-packing-list.jpg", alt: "Compressed clothing bale with Khanya packing list showing order details and shipping information" }, { src: basketsImg, alt: "Colorful assorted clothing displayed in baskets ready for sale" }, { src: marketDisplayImg, alt: "Colorful t-shirts hanging on display line at outdoor market with customers browsing" }, { src: "/lovable-uploads/2c9af322-a6d3-4b2a-8692-a7f8bddb0726.png", alt: "Informal trader selling affordable clothing at a township market stall" }].map((img) => (
